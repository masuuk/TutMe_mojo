...
#
#  Source:  public/data_science/perceptrons_and_activation.html
#  File:    perceptrons_and_activation_initialize_weights_zeros.mojo
#
#  Extracted verbatim from the page code block (see the tutorial for prose
#  that explains each part). Run with:   mojo perceptrons_and_activation_initialize_weights_zeros.mojo
# ============================================================================
from std.math import sqrt, exp, min, max
