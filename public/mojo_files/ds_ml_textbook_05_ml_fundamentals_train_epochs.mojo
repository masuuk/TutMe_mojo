...
#
#  Source:  public/data_science/ds_ml_textbook_05_ml_fundamentals.html
#  File:    ds_ml_textbook_05_ml_fundamentals_train_epochs.mojo
#
#  Extracted verbatim from the page code block (see the tutorial for prose
#  that explains each part). Run with:   mojo ds_ml_textbook_05_ml_fundamentals_train_epochs.mojo
# ============================================================================
from std.math import sqrt
from std.random import random_normal, seed
