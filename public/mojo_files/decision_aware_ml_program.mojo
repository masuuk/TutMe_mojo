...
#
#  Source:  public/data_science/decision_aware_ml.html
#  File:    decision_aware_ml_program.mojo
#
#  Extracted verbatim from the page code block (see the tutorial for prose
#  that explains each part). Run with:   mojo decision_aware_ml_program.mojo
# ============================================================================
