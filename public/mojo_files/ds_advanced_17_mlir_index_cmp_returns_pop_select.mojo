...
#
#  Source:  public/data_science/ds_advanced_17_mlir.html
#  File:    ds_advanced_17_mlir_index_cmp_returns_pop_select.mojo
#
#  Extracted verbatim from the page code block (see the tutorial for prose
#  that explains each part). Run with:   mojo ds_advanced_17_mlir_index_cmp_returns_pop_select.mojo
# ============================================================================
