...
#  File:    perceptrons_and_activation_find_numerical_stability.mojo
#
#  Extracted verbatim from the page code block (see the tutorial for prose
#  that explains each part). Run with:   mojo perceptrons_and_activation_find_numerical_stability.mojo
# ============================================================================
