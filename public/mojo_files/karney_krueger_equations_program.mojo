...
#  File:    karney_krueger_equations_program.mojo
#
#  Extracted verbatim from the page code block (see the tutorial for prose
#  that explains each part). Run with:   mojo karney_krueger_equations_program.mojo
# ============================================================================
from std.math import sqrt, sin, cos, atan2, atanh, sinh, cosh, radians
